...
public class ResourcesHandler {
	...
	public Response resource(Resources resources) {
		logger.logMessage(LogLevel.INFO, "POST Resource called ");
		Response response = null;
		ErrorsDTO errorsDTO = null;
		try {
			response = Response.status(Response.Status.CREATED).entity( resourcesServicesImpl.CreateResource(resources)).build();
	...
	public Response resource(Resources resources,
		...
		Response response = null;
		try {
			response = Response.status(Response.Status.OK).entity(resourcesServicesImpl.updateResource(
					resources, id)).build();
	...
	public Response resource(@PathParam("id") String id) {
		...
		try {
			response = Response.status(Response.Status.OK)
					.entity(resourcesServicesImpl
							.getResourceById(id)).build();
