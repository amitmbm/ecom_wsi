...
public class GroupsHandler {
	...
	static final ILogger logger = LoggerManager.getLoggerFactory().getLogger(
		...
		public Response createGroup(GroupsDTO GroupsDTO) {
			logger.logMessage(LogLevel.INFO, "POST Group called ");
			Response response = null;
			ErrorsDTO errorsDTO = null;
			try {
				// categoryServices.validateGroup(GroupsDTO);
		...
		@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
		@Consumes(MediaType.APPLICATION_JSON)
		public Response updateGroup(GroupsDTO groupsDTO,
		...
		@Path("{id}")
		@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
		public Response getSubgroup(@PathParam("id") String id) {
			Groups group = null;
			Response response = null;
			try {
